...
#print(df_all)
df_all["Production Run Time (Min)"]=pd.to_numeric(df_all["Production Run Time (Min)"])
df_all["Products Produced (Units)"]=pd.to_numeric(df_all["Products Produced (Units)"])
print(df_all)
